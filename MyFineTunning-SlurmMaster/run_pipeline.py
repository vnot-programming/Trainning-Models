...
python3: can't open file '/root/Trainning-Models/MyFineTunning-RunPOD/Trainning-Models/MyFineTunning-RunPOD/run_pipeline.py': [Errno 2] No such file or directory

  python3 /root/Trainning-Models/MyFineTunning-RunPOD/run_pipeline.py
...
def start_training(job):
    ...
    tmux_cmd = ["tmux", "new-session", "-d", "-s", session, f"bash -c '{cmd}'"]
