...
# Default dari path manapun
  tmux new-session -d -s golden_evaluation_visuals_new "cd /home/my/Trainning-Models/MyFineTunning-dev && source /data/programs/anaconda3/bin/activate && conda activate yolo_env && python3 -u utils/golden_evaluation_visuals-new_method.py --gpus all 2>&1 | tee utils/golden_evaluation_visuals-new_method.log"
