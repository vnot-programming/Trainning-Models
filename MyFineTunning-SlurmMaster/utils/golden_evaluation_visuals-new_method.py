...
3. Di dalam Node GPU, jalankan visualisasi secara langsung (Dinamis tanpa hardcode):
   ...
   python3 -u utils/golden_evaluation_visuals-new_method.py --gpus 0,1 2>&1 | tee /data/users/g6717500336/Trainning-Models/MyFineTunning-SlurmMaster/data-files/MyFineTunning-${WS_ID}/logs/golden_evaluation_visuals_new.log
