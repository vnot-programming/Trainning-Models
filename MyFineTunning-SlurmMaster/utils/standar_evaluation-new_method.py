...
# Default dari path manapun
  tmux new-session -d -s standar_evaluation-new_method "cd /home/my/Trainning-Models/MyFineTunning-dev && source /data/programs/anaconda3/bin/activate && conda activate yolo_env && python3 -u utils/standar_evaluation-new_method.py 2>&1 | tee utils/standar_evaluation-new_method.log"
