...
# Default dari path manapun
  tmux new-session -d -s standar_evaluation-new_method "cd /home/my/Trainning-Models/MyFineTunning-RunPOD && source .venv/bin/activate && python3 -u utils/standar_evaluation-new_method.py 2>&1 | tee utils/standar_evaluation-new_method.log"
