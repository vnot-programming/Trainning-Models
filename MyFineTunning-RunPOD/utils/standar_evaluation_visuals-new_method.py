...
# Default dari path manapun
  tmux new-session -d -s standar_evaluation_visuals_new "cd /home/my/Trainning-Models/MyFineTunning-RunPOD && source .venv/bin/activate && python3 -u utils/standar_evaluation_visuals-new_method.py --gpus all 2>&1 | tee utils/standar_evaluation_visuals-new_method.log"
