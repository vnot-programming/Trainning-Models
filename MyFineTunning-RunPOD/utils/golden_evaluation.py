...
Cara pakai:
  ...
  tmux new-session -d -s golden_eval "cd Trainning-Models/MyFineTunning-RunPOD && source .venv/bin/activate && python3 -u utils/golden_evaluation.py 2>&1 | tee utils/golden_evaluation.log"
